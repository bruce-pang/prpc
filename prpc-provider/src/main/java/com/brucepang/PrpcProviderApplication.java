...
import com.brucepang.prpc.spring.reference.*;
...
@ComponentScan(basePackages = {"com.brucepang.prpc.spring.service", "com.brucepang.prpc.annotation", "com.brucepang.prpc.provider.example.service"}
        /*,excludeFilters = {
